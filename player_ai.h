 ...
 * @author Nate Parlberg & Manzi Dave Rugari 
...
class Nate_Dave: public Player {
    ...
    public:
        ...
        bool safeShip(Ship ship);
        
        int hprob(int row, int col);
    
        int vprob(int row, int col);
    private:
        /// @brief 
        /// @param row 
        /// @param col 
